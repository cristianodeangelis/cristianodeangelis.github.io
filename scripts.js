        ...
        publicaciones.forEach(publicacion => {
            ...
            card.innerHTML = `
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Fecha de Publicación: ${publicacion.data}</h6>
                    <p class="card-text">${publicacion.resumo}</p>
                    <a href="${publicacion.enlace}" class="card-link">Ver completo</a>
                </div>
            `;
